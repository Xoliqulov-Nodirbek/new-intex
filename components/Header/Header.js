				...
				<div className='max-w-[1220px] mx-auto px-5 py-3.5 sm:py-4'>
					<div className='flex items-center justify-between'>
							...
							<div className='hidden items-center ml-10 xl:flex'>
								<Link
									...
									<Image
										...
										src={'/Assets/Images/drop-img.svg'}
										width={9}
										height={5}
										alt='Drop img'
									/>
						...
						<div className='flex items-center'>
							...
							/>
							<button className='bg-white hidden sm:flex ml-8 w-11 h-11   items-center justify-center cursor-pointer rounded-xl'>
								<Image
									className='w-6 h-6'
									src={BlogImg}
									width={24}
							...
							<div className='relative'>
								<div onClick={() => setOpenLang(!openLang)} className='bg-white z-50 relative language-wrap hidden cursor-pointer sm:flex ml-8 w-20  items-center justify-between py-3 pl-1 pr-2 rounded-md'>
									<Image
										className='w-7 h-5'
										src={russiaFlag}
										width={28}
								...
								<ul className={`${openLang ? "translate-y-0.5 opacity-1" : "-translate-y-16 opacity-0"} z-0 duration-300 absolute cursor-pointer shadow-lg rounded-md right-0 w-20 bg-white flex flex-col`}>
